      ...
      <form>
        <FormGroup aria-label='position'>
          ...
          <div className={classes.padding}>
            ...
            <Grid container spacing={1}>
              <Grid item size={6}>
                <TextInput label='grid X' value={snap.x} variant='outlined' size='small' onChange={(e) => handleSnapChange({ x: Number(e.target.value) })} />
              </Grid>
              <Grid item size={6}>
                <TextInput label='grid Y' value={snap.y} variant='outlined' size='small' onChange={(e) => handleSnapChange({ y: Number(e.target.value) })} />
              </Grid>
              <Grid item size={6}>
